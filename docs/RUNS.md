...
| reward_length_g2_seed42 | f50d731 | reward-length-bk | G2 baseline + `length_penalty` reward (`LENGTH_TARGET=600`, cap `-1.0`) | 42 | 3364 | ~2h34m (approx; see W&B) | preserved on TPU VM `basia`: `/home/basiakoch/preserved/length_g2_content/ckpts/actor/{2000,2500,3000,3364}`; W&B artifact `reward_length_g2_seed42_checkpoint:latest` | GSM8K test, 64-example greedy | eval pending | https://wandb.ai/felsomoye-university-of-cambridge/tunix/runs/jcp0b5cy; upload run https://wandb.ai/felsomoye-university-of-cambridge/tunix/runs/gy146naa | completed | Initially almost lost because preservation commands were run on the Mac shell; recovered from remote `/tmp/content`, saved under `~/preserved` on the TPU VM, and uploaded as a W&B model artifact. See `runs/2026-06-11_reward_length_g2_seed42/`. |
