...
THIS DIRECTORY CONTAINS THE ORIGINAL SCRIPTS FROM https://github.com/borisbolliet/tpu-2026.git AT COMMIT ID: 77c5a67034a7daa869066d1955b06cdca49f9887

**These files are to be used as a reference only, and not edited.**

Use these files for controlled comparisons against our scripts, to understand where changes have been made relative to the baseline.
